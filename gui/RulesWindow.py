    ...
    def init_ui(self):
        ...
        self.textBrowser.setHtml("""
            ...
            <ul>
                ...
                <li>После каждого хода на поле появляются 3 новых шара. Если новый шар появляется на месте, куда был перемещен последний шар, линии формируются автоматически.</li>
